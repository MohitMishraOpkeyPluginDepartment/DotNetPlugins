...
SET BROWSER=C:\Program Files\Mozilla Firefox 4.0 Beta 7\firefox.exe
...
echo "Example:" 
echo "%0 demo/demo.suite http://sahipro.com/demo/"
echo "%0 demo/sahi_demo.sah http://sahipro.com/demo/"