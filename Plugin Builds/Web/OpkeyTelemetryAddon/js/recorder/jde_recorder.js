//init Oracle Fusion
var JDERecorder = function() {

}

JDERecorder.prototype.IsElementIsVisible = function(el) {
	if (el) {
...
JDERecorder.prototype.getJDERecorderLabelComponent = function(el) {
	// ////debugger;
...
JDERecorder.prototype.checkPreviousSiblingForOF = function(el, lbl_element,
		id_Attr_Value) {
	var lbl_elem = null;
...
JDERecorder.prototype.checkNextSiblingForOF = function(el, lbl_element,
		id_Attr_Value) {
...
JDERecorder.prototype.checkParentNodeForOF = function(el, lbl_element,
		id_Attr_Value) {
	var iterationrate = 0;
...
JDERecorder.prototype.checkChildNodeForOF = function(el, lbl_element,
		id_Attr_Value) {
...
JDERecorder.prototype.checkInputElementsForOF = function(el) {
...
JDERecorder.prototype.getSeleniumAccessorsForOF = function(el) {
	var locators = [];
	try {
...
JDERecorder.prototype.GetNodeFromXath = function(_refNode, _xpath) {
	if (_refNode == null) {
		_refNode = document;
	}
	var opkey_results = [];
...
JDERecorder.prototype.FusionGetPopUp = function() {
...
JDERecorder.prototype.GetObjectHeader = function() {
...
JDERecorder.prototype.GetLabelProperties = function(_component, ref_object) {
	...
	try {
		...
		var _label = this.getJDERecorderLabelComponent(_component);
		...
		if (_header) {
			ref_object["JDE:Header"] = _header;
		}
		if (_label != null) {
			// debugger;
			ref_object["JDE:label:text"] = _label.textContent;
			...
			for (var _li = 0; _li < _locators.length; _li++) {
				_locators[_li][1] = "JDE:" + _locators[_li][1];
...
JDERecorder.prototype.GetCompositeKeywords = function(_element, ref_object) {
...
JDERecorder.prototype.GetClosestElement = function(element, selector) { // Find
																			// closest
																			// Required
																			// Element
...
JDERecorder.prototype.GetTableProp = function(_currentelement) {
