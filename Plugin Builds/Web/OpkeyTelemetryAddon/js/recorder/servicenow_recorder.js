//init Oracle Fusion
var ServiceNow = function() {

}

ServiceNow.prototype.IsElementIsVisible = function(el) {
	if (el) {
...
ServiceNow.prototype.getOracleFusionLabelComponent = function(el) {
	// ////debugger;
...
ServiceNow.prototype.checkPreviousSiblingForOF = function(el, lbl_element,
		id_Attr_Value) {
	var lbl_elem = null;
...
ServiceNow.prototype.checkNextSiblingForOF = function(el, lbl_element,
		id_Attr_Value) {
...
ServiceNow.prototype.checkParentNodeForOF = function(el, lbl_element,
		id_Attr_Value) {
	var iterationrate = 0;
...
ServiceNow.prototype.checkChildNodeForOF = function(el, lbl_element,
		id_Attr_Value) {
...
ServiceNow.prototype.checkInputElementsForOF = function(el) {
...
ServiceNow.prototype.getSeleniumAccessorsForOF = function(el) {
	var locators = [];
	try {
...
ServiceNow.prototype.GetNodeFromXath = function(_refNode, _xpath) {
	if (_refNode == null) {
		_refNode = document;
	}
	var opkey_results = [];
...
ServiceNow.prototype.FusionGetPopUp = function() {
...
ServiceNow.prototype.GetObjectHeader = function() {
...
ServiceNow.prototype.GetLabelProperties = function(_component, ref_object) {
...
ServiceNow.prototype.GetCompositeKeywords = function(_element, ref_object) {
...
ServiceNow.prototype.GetClosestElement = function(element, selector) { // Find
																			// closest
																			// Required
																			// Element
...
ServiceNow.prototype.GetTableProp = function(_currentelement) {
