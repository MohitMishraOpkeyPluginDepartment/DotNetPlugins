//init Oracle Fusion
var MSDynamicsAX = function() {

}

MSDynamicsAX.prototype.IsElementIsVisible = function(el) {
	if (el) {
...
MSDynamicsAX.prototype.getMSDynamicsAXLabelComponent = function(el) {
	// ////debugger;
...
MSDynamicsAX.prototype.checkPreviousSiblingForOF = function(el, lbl_element,
	id_Attr_Value) {
	var lbl_elem = null;
...
MSDynamicsAX.prototype.checkNextSiblingForOF = function(el, lbl_element,
	id_Attr_Value) {
...
MSDynamicsAX.prototype.checkParentNodeForOF = function(el, lbl_element,
	id_Attr_Value) {
	var iterationrate = 0;
...
MSDynamicsAX.prototype.checkChildNodeForOF = function(el, lbl_element,
	id_Attr_Value) {
...
MSDynamicsAX.prototype.checkInputElementsForOF = function(el) {
...
MSDynamicsAX.prototype.getSeleniumAccessorsForOF = function(el) {
	var locators = [];
	try {
...
MSDynamicsAX.prototype.GetNodeFromXath = function(_refNode, _xpath) {
	if (_refNode == null) {
		_refNode = document;
	}
	var opkey_results = [];
...
MSDynamicsAX.prototype.FusionGetPopUp = function() {
...
MSDynamicsAX.prototype.GetObjectHeader = function() {
...
MSDynamicsAX.prototype.GetSpanLabelComponent = function(_component) {
var _newComponent=_component;
while(_newComponent!=null){
	if(_newComponent.nodeName=="TD"){
		var _previousSiblingTD=_newComponent.previousSibling;
		if(_previousSiblingTD!=null){
			if(_previousSiblingTD.nodeName=="TD"){
		       var _choldNodesOfTr=_previousSiblingTD.getElementsByTagName("SPAN");
		       var foundNodes=[];
		       for(var cns=0;cns<_choldNodesOfTr.length;cns++){
			   var _spanNode=_choldNodesOfTr[cns];
			   if(_spanNode.classList!=null){
			   if(_spanNode.classList.contains("ms-crm-InlineEditLabelText")){
					foundNodes.push(_spanNode);
				}
			}
		}
		if(foundNodes.length>0){
			return foundNodes[foundNodes.length-1];
		}
		break;
		}
		}
...
MSDynamicsAX.prototype.GetLabelProperties = function(_component, ref_object) {
	...
	try {
		...
		if (_header) {
			ref_object["MD:Header"] = _header;
		}
		if (_label != null) {
			// debugger;
			ref_object["MD:label:text"] = _label.textContent;
			ref_object["logicalname"] = _label.textContent;
			if(_component.getAttribute("aria-labelledby")==null){
			if(_component.getAttribute("title")!=null){
				if(_component.getAttribute("title")!=""){
					ref_object["logicalname"]=_component.getAttribute("title");
				}
			}
			}
			var _locators = this.getSeleniumAccessorsForOF(_label);
			for (var _li = 0; _li < _locators.length; _li++) {
				_locators[_li][1] = "MD:" + _locators[_li][1];
			...
			if (_ariaLabel != null) {
				ref_object["MD:label:text"] = _ariaLabel.replace(", (Blank)", "");
				ref_object["MD:arialabel"] = _ariaLabel.replace(", (Blank)", "");
			...
			if(_component.getAttribute("aria-labelledby")==null){
			var title_1=_component.getAttribute("title");
			if(title_1!=null){
				ref_object["logicalname"] = title_1;
			}
			}
			var _ariarole = _component.getAttribute("role");
			if (_ariarole != null) {
				ref_object["MD:role"] = _ariarole;
			}

			var _ariaposinset = _component.getAttribute("aria-posinset");
			if (_ariaposinset != null) {
				ref_object["MD:ariaposinset"] = _ariaposinset;
			}

			var _ariahaspopup = _component.getAttribute("aria-haspopup");
			if (_ariahaspopup != null) {
				ref_object["MD:ariahaspopup"] = _ariahaspopup;
			}
			...
			if (_ariacontrols != null) {
			    ...
			    if (_ariaLabel != null) {
					ref_object["MD:Input:arialabel"] = _ariaLabel.replace(", (Blank)", "");
				}
				}
			}
			...
			if (_controlName != null) {
				ref_object["MD:controlname"] = _controlName;
			}
		}
		
		if(_component.nodeName=="INPUT"){
		   if(_component.readOnly!=null){
			if(_component.readOnly==true){
				if(_component.getAttribute("aria-labelledby")==null){
				var title_1_new=_component.getAttribute("data-dyn-savedtooltip");
				if(title_1_new==null){
					title_1_new=_component.getAttribute("title");
				}
				if(title_1_new==null){
					title_1_new=_component.getAttribute("alt");
				}
				console.log("Title is  "+title_1_new)
				if(title_1_new!=null){
				   ref_object["logicalname"] = title_1_new;
				}
				}
			}
		}
	}
	console.log("Logical Name "+ref_object["logicalname"]);
	} catch (e) {
		return null;
	}
};
...
MSDynamicsAX.prototype.GetCompositeKeywords = function(_element, ref_object) {
...
MSDynamicsAX.prototype.GetClosestElement = function(element, selector) { // Find
	// closest
	// Required
	// Element
...
MSDynamicsAX.prototype.GetTableProp = function(_currentelement) {
