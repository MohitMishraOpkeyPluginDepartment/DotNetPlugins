//init SuccessFactors
var SuccessFactors = function() {

}

SuccessFactors.prototype.IsElementIsVisible = function(el) {
	if (el) {
...
SuccessFactors.prototype.getOracleFusionLabelComponent = function(el) {
	// ////debugger;
...
SuccessFactors.prototype.checkPreviousSiblingForOF = function(el, lbl_element,
		id_Attr_Value) {
	var lbl_elem = null;
...
SuccessFactors.prototype.checkNextSiblingForOF = function(el, lbl_element,
		id_Attr_Value) {
...
SuccessFactors.prototype.checkParentNodeForOF = function(el, lbl_element,
		id_Attr_Value) {
	var iterationrate = 0;
...
SuccessFactors.prototype.checkChildNodeForOF = function(el, lbl_element,
		id_Attr_Value) {
...
SuccessFactors.prototype.checkInputElementsForOF = function(el) {
...
SuccessFactors.prototype.getSeleniumAccessorsForOF = function(el) {
	var locators = [];
	try {
...
SuccessFactors.prototype.GetNodeFromXath = function(_refNode, _xpath) {
	if (_refNode == null) {
		_refNode = document;
	}
	var opkey_results = [];
...
SuccessFactors.prototype.FusionGetPopUp = function() {
...
SuccessFactors.prototype.GetObjectHeader = function() {
...
SuccessFactors.prototype.GetLabelProperties = function(_component, ref_object) {
	...
	try {
		...
		if (_header) {
			ref_object["SSF:Header"] = _header;
		}
		if (_label != null) {
			// debugger;
			ref_object["SSF:label:text"] = _label.textContent;
			...
			for (var _li = 0; _li < _locators.length; _li++) {
				_locators[_li][1] = "SSF:" + _locators[_li][1];
...
SuccessFactors.prototype.GetCompositeKeywords = function(_element, ref_object) {
...
SuccessFactors.prototype.GetClosestElement = function(element, selector) { // Find
																			// closest
																			// Required
																			// Element
...
SuccessFactors.prototype.GetTableProp = function(_currentelement) {
