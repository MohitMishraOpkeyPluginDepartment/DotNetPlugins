...
(function (root, factory) {
    ...
    Toastify.lib = Toastify.prototype = {
        ...
        init: function (options) {
            ...
            this.options.gravity = (options.gravity == "bottom") ? "opkeyrecorderbottom" : "opkeyrecordertop"; // toast position - top or bottom
        ...
        buildToast: function () {
            ...
            divElement.className = 'opkeyrecordertoastify on';

            // Positioning toast to left or right
            if (this.options.positionLeft === true) {
                divElement.className += " opkeyrecorderleft";
            } else {
                divElement.className += " opkeyrecorderright";
            }
            ...
            divElement.innerHTML = DOMPurify.sanitize(this.options.text);

            if (this.options.avatar !== "") {
                var avatarElement = document.createElement("img");
                avatarElement.src = this.options.avatar;

                avatarElement.className = "opkeyrecorderavatar";
            ...
            if (this.options.close === true) {
                ...
                closeElement.className = 'opkeyrecordertoast-close';
    ...
    Toastify.reposition = function () {
        ...
        var allToasts = document.getElementsByClassName('opkeyrecordertoastify');
