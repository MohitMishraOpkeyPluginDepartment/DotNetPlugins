...
public class MyScript extends MyScriptHelper
{
	...
	//public static String sCurPath = System.getenv("sCurPath");	
	...
	public static String steptimeout1;	
	...
	public static String str = "";
	 static Object StepNumber;
	public static boolean methodfound = false;
	public static Object msg = null;
	 public static String id1;
	 public static String resultstring1;
	 public static String resultstring;
	 static String RFTPath[];
		public static String runtimelibpath = "";
	...
	public void testMain(Object[] args) throws SQLException, InterruptedException
	{
		...
		try
		{
		   ...
		   // JOptionPane.showMessageDialog(null,"Test Main Method:: " + workingdir ,"TITLE",JOptionPane.WARNING_MESSAGE);
		
		    runtimelibpath = workingdir + "\\" + "Communication.db";
		    
		   // JOptionPane.showMessageDialog(null,"Test Main Method:: " + runtimelibpath ,"TITLE",JOptionPane.WARNING_MESSAGE);
			
			Class.forName("org.sqlite.JDBC");		
		    conn = DriverManager.getConnection("jdbc:sqlite:" + runtimelibpath);			    
...
//				stat.executeUpdate(str);
			 ...
			 System.out.println("New1 Keyword Started");
	            String id = UUID.randomUUID().toString();
	            String resultstring = "<FunctionResult xmlns:Opkey='http://opkey.crestechglobal.com/xml/functioncall'><StepNumber>" + StepNumber + "</StepNumber><Status>False</Status><Output>false</Output><Message> <![CDATA[" + e.getMessage() + "]]></Message><ErrorCode>15</ErrorCode><SnapshotPath/></FunctionResult>";
	            resultstring = '"' + resultstring + '"';
	           // resultstring.replace("'","");
	            stat.executeUpdate("INSERT INTO PLUGIN_TO_OPKEY (msg_id, msg) VALUES ('" + id + "'," + resultstring + ");");
...
public static void ExecuteKeyword(MyScript myscrpt) throws SQLException
{
    ...
    String str = "SELECT MSG_ID, MSG FROM OPKEY_TO_PLUGIN";
	 try 
	{
		 	conn = DriverManager.getConnection("jdbc:sqlite:" + runtimelibpath);			    
		    stat = conn.createStatement();			
		    ...
		    if (rs.next()) {
                commandstring = rs.getString("MSG");
                System.out.println("commandstring12334" + commandstring);
                String MSG_ID = rs.getString("MSG_ID");
                stat.execute("DELETE FROM OPKEY_TO_PLUGIN WHERE MSG_ID = '" + MSG_ID + "';");
                message = "";
                status = "fail";
                opvar = "";									
	        ...
	        NodeList nodes;
	        //Get step Number
	        nodes = doc.getElementsByTagName("Opkey:StepNumber");
            Element n1 = (Element) nodes.item(0);
            StepNumber = n1.getTextContent();
	        ...
	        steptimeout1 = n.getAttribute("callTimeoutInMillis");
	        steptimeout = Long.parseLong(steptimeout1);
...
//--------------------------------------------------------------------
	       ...
	       // Class<?> cls = Class.forName("RFTPackage.RFTlibclass"); 
			Class<?> cls = Class.forName("RFTPackage.RFTlibclass");
	        ///String RFTPath = "sCurPath\\Library\\RFTworkspace\\MyRFTProj\\resources";
			String[] RFTpath = runtimelibpath.split("Communication.db");
	        File dir = new File(RFTpath[0]);
        	...
        	if ((msg == null) && (methodfound == false))
			{
				...
				for(int f=0; f < listOfFiles.length; f++)
				{
					if (methodfound)
						break;
					//String jarpath = sCurPath + "\\" + listOfFiles[f];
					String jarpath = RFTpath[0] + "\\"  +listOfFiles[f];
...
//						message = methodname + " returns no output.";
					message = methodname + " returns not find";
                    System.out.println(message);
                    resultstring1 = "<FunctionResult xmlns:Opkey='http://opkey.crestechglobal.com/xml/functioncall'><StepNumber>" + StepNumber + "</StepNumber><Status>fail</Status><Output>false</Output><Message> " + message + "</Message><ErrorCode>15</ErrorCode><SnapshotPath/></FunctionResult>";
                    //resultstring1='"'+resultstring1+'"';
					}
					else
					{
						System.out.println("Result xml: "+ msg);
						resultstring1=(String) msg;						
						try
						{
...
//							message = message.replaceAll("'","''");
							 resultstring1 = resultstring1.replaceAll("<StepNumber>null</StepNumber>", "<StepNumber>" + StepNumber + "</StepNumber>");
		                        System.out.println("Returned message from xml: " + resultstring1);
						}
						catch(Exception e)
						{
							e.printStackTrace();
...
//				 message= methodname + " not found.";	
				 message = methodname + " not found.";
                 resultstring1 = "<FunctionResult xmlns:Opkey='http://opkey.crestechglobal.com/xml/functioncall'><StepNumber>" + StepNumber + "</StepNumber><Status>fail</Status><Output>false</Output><Message> " + message + "</Message><ErrorCode>16</ErrorCode><SnapshotPath/></FunctionResult>";
...
//			stat.executeUpdate(str);	
			...
			System.out.println("runtimelibpath" + runtimelibpath);
            System.out.println("resultstring1" + resultstring1);
            
           // JOptionPane.showMessageDialog(null,"runtimelibpath" + runtimelibpath + str,"TITLE",JOptionPane.WARNING_MESSAGE);
            str = "INSERT INTO PLUGIN_TO_OPKEY (msg_id, msg) VALUES ('" + id1 + "'," + resultstring1 + ");";
            System.out.println(str);
          //  JOptionPane.showMessageDialog(null,"Going to insert Query:: " + str,"TITLE",JOptionPane.WARNING_MESSAGE);
            int queryStatus = stat.executeUpdate(str);
          //  JOptionPane.showMessageDialog(null,"Inserted Query and Query Status is:: " + queryStatus,"TITLE",JOptionPane.WARNING_MESSAGE);
...
//			str= "update " + executiontab + " set PluginFlag='1'  where username=" + "'"  +  currentuser + "'";
//			stat.executeUpdate(str);
		 resultstring1 = "<FunctionResult xmlns:Opkey='http://opkey.crestechglobal.com/xml/functioncall'><StepNumber>" + StepNumber + "</StepNumber><Status>fail</Status><Output>false</Output><Message> " + e.getMessage() + "</Message><ErrorCode>17</ErrorCode><SnapshotPath/></FunctionResult>";
         resultstring1 = '"' + resultstring1 + '"';
