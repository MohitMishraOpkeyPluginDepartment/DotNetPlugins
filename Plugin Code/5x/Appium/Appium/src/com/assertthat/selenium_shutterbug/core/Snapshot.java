...
public abstract class Snapshot<T extends Snapshot> {
	...
	/**
	 * @param name file name of the resulted image by default will be timestamp in
	...
	/**
	 * Generate a thumbnail of the original screenshot. Will save different
	 * thumbnails depends on when it was called in the chain.
	 *
	...
	/**
	 * Final method to be called in the chain. Actually saves processed image to the
	 ...
	 * @return true if the the percentage of differences between current image and
	 *         provided one is less than or equal to <b>deviation</b>
	 */
	public boolean equals(Object o, double deviation) {
		...
		return getImage() != null ? ImageProcessor.imagesAreEquals(getImage(), that.getImage(), deviation)
				: that.getImage() == null;
	}

	/**
	 * @param o Object to compare with
	 * @return true if the the provided object is of type Snapshot and images are
	 *         strictly equal.
	 */
	@Override
	public boolean equals(Object o) {
		...
		return getImage() != null ? ImageProcessor.imagesAreEquals(getImage(), that.getImage(), 0)
				: that.getImage() == null;
	}
