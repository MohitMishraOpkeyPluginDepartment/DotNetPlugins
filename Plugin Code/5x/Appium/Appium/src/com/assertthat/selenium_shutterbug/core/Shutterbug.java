...
public class Shutterbug {
	...
	/**
	 * Make screenshot of the viewport only. To be used when screenshotting the page
	...
	/**
	 * To be used when screenshotting the page and need to scroll while making
	 * screenshots, either vertically or horizontally or both directions (Chrome).
	 *
	 * @param driver WebDriver instance
	 ...
	 */
	public static PageSnapshot shootPage(WebDriver driver, ScrollStrategy scroll) throws ToolNotSetException {
		Browser browser = new Browser(driver);
		PageSnapshot pageScreenshot = new PageSnapshot(driver);
		switch (scroll) {
		case HORIZONTALLY:
